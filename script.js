...
window.addEventListener('scroll', () => {
    if (scrollY > 50) {
        ...
        navLinks.classList.remove('bg-white', 'shadow:sm', 'bg-opacity-50', 'dark:border', 'dark:border-white/70',
            'dark:');
    } else {
        navBar.classList.remove('bg-white', 'bg-opacity-50', 'backdrop-blur-lg', 'shadow:sm','dark:bg-darkTheme',
            'dark:shadow-white/20');
        navLinks.classList.add('bg-white', 'shadow:sm', 'bg-opacity-50' , 'dark:border', 'dark:border-white/70',
            'dark:');
    }
})
